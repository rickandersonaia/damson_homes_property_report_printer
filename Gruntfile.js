    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/damson-homes-property-report-generator.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/damson-homes-property-report-generator.min.css': 'assets/css/damson-homes-property-report-generator.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/damson-homes-property-report-generator.min.css'] }
            }
        }
    });
